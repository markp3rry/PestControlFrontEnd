...
for(var n in d){
    if(d[f](n)){
        ...
        switch(n){
            ...
            case"rx":
                if(n=="rx"&&c.type=="rect")break;case"cx":
            ...
            case"ry":
                if(n=="ry"&&c.type=="rect")break;case"cy":
...
bN[e].attr=function(b,c){
    ...
    if(b==null){
        ...
        for(var e in this.attrs)this.attrs[f](e)&&(d[e]=this.attrs[e]);this._.rt.deg&&(d.rotation=this.rotate());
...
if(a.vml){
    ...
    bK=function(c,d){
        ...
        for(var n in d)d[f](n)&&(h[n]=d[n]);if(k){
...
bO.setBox=function(a,b,c){
    ...
    for(var g in a)a[f](g)&&(this.attrs[g]=a[g]);b=b||this._.rt.cx;
    c=c||this._.rt.cy;
...
k.remove=function(){
    ...
    for(var a in this)this[a]=bF(a);return true
    }
}
    ...
    if(a!=0){
        ...
        switch(this.type){
            ...
            case"path":
                ...
                else if(N=="V")for(O=1,P=M[w];O<P;O++)M[O]*=J;else for(O=1,P=M[w];O<P;O++)M[O]*=O%2?I:J
                    }
                    var Q=bn(G);
                e=A-Q.x-Q.width/2;
                f=C-Q.y-Q.height/2;
...
for(var d in a.face)a.face[f](d)&&(b.face[d]=a.face[d]);this.fonts[c]?this.fonts[c][L](b):this.fonts[c]=[b];
if(!a.svg){
